...
const CustomerProfile = () => {
    ...
    const {
        ...
        session ? [params.cid, session.accessToken] : null, ([customerId, token]) => customerFetcher(customerId, token));
    ...
    const handelSubmit = async (event: any) => {
        ...
        if (checker == 0) {
            ...
            await updateCustomerInfo(data, params.cid, session?.accessToken)
