...
const ChatIcon = () => {
    return (
        <button className='shadow-xl fixed bottom-5 right-5 inline-flex items-center w-12 h-12 justify-center overflow-hidden transition-all bg-primary-white rounded-full hover:bg-primary-white group'>
