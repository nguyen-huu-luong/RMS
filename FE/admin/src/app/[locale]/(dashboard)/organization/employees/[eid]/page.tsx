...
const CustomerProfile = () => {
    ...
    let userInfo: any = {
        ...
        "phone": customerInfo.phone, "birthday": customerInfo.birthday.split("T")[0], "email": customerInfo.email
    }
    ...
    return (
        <div className="text-sm font-medium" style={{ backgroundColor: "#F8F8F8" }}>
            {editFlag &&
