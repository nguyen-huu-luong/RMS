...
const LeadProfile = () => {
    ...
    if (leadInfoLoading) {
        ...
        if (leadInfo) {
            userInfo = {
                ...
                "phone": leadInfo.phone, "birthday": leadInfo.birthday ? leadInfo.birthday.split("T")[0] : leadInfo.birthday, "email": leadInfo.email
            }
        }
    }
    ...
    return (
        <>
            {
                leadInfo ? (<div className="text-sm font-medium" style={{ backgroundColor: "#F8F8F8" }}>
                    {editFlag &&
                            ...
                            <div className="col-span-2">
                                <div className="bg-white pl-3 py-2">
                                    ...
                                    <div className="mt-3 grid grid-cols-5 gap-4">
                                        <div style={{ width: "120px", height: "120px" }} className="overflow-hidden aspect-square rounded-full">
                                            <img src={leadInfo.avatar} alt="user avatar" />
                                        </div>
                                        <div>
                                ...
                                <div className="bg-white  py-2 mt-3">
                                    <div className="text-sm font-medium text-center text-gray-500 border-b border-gray-200 dark:text-gray-400 dark:border-gray-700">
                                        <ul className="flex flex-wrap -mb-px">
                                            <li className="me-2">
                                                <button type="button" className={tabStyle[tab]} onClick={() => handelTabClick(0)}>Activities</button>
                                            </li>
                                        </ul>
                                    </div>
