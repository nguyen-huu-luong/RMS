                ...
                >
                    ...
                    <Form.Item>
                        <div className="flex flex-row justify-between items-center">
                            ...
                            <a className="login-form-forgot hover:text-primary" href="">
                                Forgot password?
                            </a>
                        </div>
                    </Form.Item>
                    ...
                    <div className="flex gap-4" >
                        <Button className="w-full flex items-center justify-center" onClick={signInGoogle}>
                            <Image src={"/google-icon.webp"} width={24} height={24} alt="" className="me-2" /><span>Google</span>
                        </Button>
                        <Button className="w-full flex items-center justify-center">
                            <img src={"/Facebook.png"} width={24} height={24} alt="" className="me-2" /><span>Facebook</span>
                        </Button>
                    </div>
